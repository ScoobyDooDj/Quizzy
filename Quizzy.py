...
class SplashScreen:
    def __init__(self, root, app):
        ...
        self.splash_image = PhotoImage(file=app.current_background_path)
...
class QuizApp:
    def __init__(self, root, csv_file):
        ...
        self.background_image = PhotoImage(file=r'C:\Quizzy\Background\background.png')
        ...
        self.answer_label.place(relx=0.37, rely=0.86)  # Moved to the left by 100 pixels
    ...
    def create_user_answer_entries(self):
        ...
        for i, entry in enumerate(self.user_answer_entries):
            entry.place(relx=0.45, rely=0.8 + (i * 0.05))  # Adjust y-coordinate based on the index
